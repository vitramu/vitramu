...
//                    .choice(DefinitionState.CHOICE_EW.getName())
                    ...
                    .and()
                    .withStates()
//                    .parent(DefinitionState.CREATE_BOOKING.getName()).zeroIngoing(DefinitionState.CREATE_OSB.getName())
                    .state(DefinitionState.CREATE_OSB.getName())
//                    .end(DefinitionState.END_OSB.getName())
                    .and()
                    .withStates()
//                    .parent(DefinitionState.CREATE_BOOKING.getName()).zeroIngoing(DefinitionState.CREATE_PUD.getName())
